...
export default function BlogListingPage() {
  ...
  const posts: BlogPost[] = [
    {
      ...
      authorImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBzQL-tqoi4mBI4rAj-vnlNIljOiw2PZRLb5hUxqSfsI0elcXXJiqk2IJlFw8vt6tw1MLr_TCP9pZC4CMTAZ0S4wbZooZvksKcFBNLok_ndGfWUbo5eROBFoiAujUv5bRmZTqpHmgCeOFVpW53IP-rGf4Vx-fJ6c4EcBdTgGqP0a3agXDmCZBzRI-tvjZOtHqCVmmDEg2AOtZCUUamX55TFgrGF0f52avx1tlTxH3USRVfZXv04r8E0IBx0dOAgUFjOZ7OSmIwJTFg',
      excerpt: 'How genomic sequencing is revolutionizing personalized treatment plans for complex oncology and cardiology cases globally.',
    ...
    },
    {
      ...
      authorImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDpGQKjQRlIUuAhUeL_ErrdJywQnOJAVvr_97itJGV-6f1dBnGZQdmohbRPvkshu4pOWAHQYZ7vsAWKoVWNuKvoicsoftVE3WdZU-9CAzBqwZdDuhBRrVSTsfpTt6Qh8PoTvFlJg8b7_EFUTua5U2ZiAYF1bTUCu0jNAw-_LiEXuhCEFSvLZuwkB0Kvu5aDViRaGzQMHQxzQ7cm4UslSIueco9nEvVwVnVv70TN_438gGZidBNSAQmIsa80J_yyVJNu0ufCQlzvK7k',
      excerpt: 'A comprehensive handbook for patients seeking specialized treatment across international borders and JCI facilities.',
      image: 'https://images.unsplash.com/photo-1504813184591-01592f259ff2?auto=format&fit=crop&w=800&q=80'
    },
    {
    ...
    },
    {
      ...
      authorImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDj15iel4u7hhT8qPvpcL_GgJzIU7hWg6jf_YoRJ5NVFYgx6opJIv76CL5Ymke99jSGT62uuR4rr0X8SVL956DhGM5MQGvSD1d3_M-WIftfqGdby0COMKV2J0fbf-PpW7WX_oUrV74GPfT9o-HP_sIagJ82Bt0JWSBXW5z0v2Cp4QYRL6r8BFEquNCy1eWVCUDpyCufbp6IvQ7YD7_N-wyZPQ8WrmepyPf573Ei3qXpnYEnQZEYLHpFPYccBZmRH2YnlECK15mcYkQ',
      excerpt: 'An operational guide to medical travel logistics, fast-tracking visas, and coordination details for families.',
  ...
  return (
    <div className="flex flex-col w-full bg-background min-h-screen">
      ...
      {/* Hero Header */}
      <section className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-[120px] py-16 relative z-10 animate-fade-in">
        <div className="max-w-3xl">
          <span className="text-primary font-label-sm tracking-widest block mb-4 uppercase">Shifa Insights</span>
          ...
          <p className="font-body-lg text-body-lg text-on-surface-variant leading-relaxed">
            Expert perspectives on global healthcare, patient advocacy, medical innovations, and cross-border recovery pathways.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-[120px] mb-24 relative z-10">
        {filteredPosts.length > 0 ? (
                ...
                <div className="px-8 pb-8 pt-4 border-t border-outline-variant/10 flex items-center justify-between mt-auto">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-3xs text-on-surface-variant uppercase tracking-wider">{post.date}</p>
                    </div>
                  </div>
                  <Link 
                    href={`/blog/${post.slug}`} 
          ...
          <div className="text-center py-20 bg-white/20 rounded-2xl border border-dashed border-outline-variant/30">
            ...
            <h3 className="font-headline-md text-headline-md text-on-surface mb-2">No articles found</h3>
