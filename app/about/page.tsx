...
export default function AboutPage() {
  ...
  const values = [
    {
      ...
      description: 'We prioritize medical integrity above all else, ensuring unbiased advice and strictly confidential patient data management.'
    },
    {
      ...
      description: 'Our network is restricted to JCI-accredited institutions and specialists with proven track records of excellence.'
    },
    {
      ...
      description: 'Every decision starts and ends with the patient\'s well-being, comfort, and personalized healthcare journey.'
    }
  ];
  ...
  const timeline = [
    {
      year: '2012',
      title: 'The Inception',
      description: 'Founded in Zurich with a mission to simplify cross-border cardiac consultancy.',
      color: 'bg-primary'
    },
    {
      year: '2015',
      title: 'European Expansion',
      description: 'Partnership with top 10 European oncology centers established.',
      color: 'bg-secondary'
    },
    {
      year: '2019',
      title: 'Global Digital Hub',
      description: 'Launched the proprietary \'GlobalCare\' digital platform for secure medical records.',
      color: 'bg-primary'
    },
    {
      year: '2024',
      title: 'A New Era',
      description: 'Managing over 5,000 cases annually across 4 continents and 40+ medical specialties.',
  ...
  const leaders = [
    ...
    },
    {
      ...
      image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDpGQKjQRlIUuAhUeL_ErrdJywQnOJAVvr_97itJGV-6f1dBnGZQdmohbRPvkshu4pOWAHQYZ7vsAWKoVWNuKvoicsoftVE3WdZU-9CAzBqwZdDuhBRrVSTsfpTt6Qh8PoTvFlJg8b7_EFUTua5U2ZiAYF1bTUCu0jNAw-_LiEXuhCEFSvLZuwkB0Kvu5aDViRaGzQMHQxzQ7cm4UslSIueco9nEvVwVnVv70TN_438gGZidBNSAQmIsa80J_yyVJNu0ufCQlzvK7k',
  ...
  return (
    <div className="flex flex-col w-full bg-background min-h-screen">
      ...
      <section className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-[120px] py-16 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="reveal">
            <span className="text-primary font-label-sm tracking-widest block mb-4 uppercase">Who We Are</span>
            ...
            <p className="font-body-lg text-body-lg text-on-surface-variant leading-relaxed mb-8">
              At Shifa Global Care, we bridge the gap between world-class medical expertise and the patients who need it most. Our mission is to facilitate seamless, transparent, and ethically-driven medical consultancy across the globe.
            </p>
            <div className="grid grid-cols-2 gap-8 pt-4 border-t border-outline-variant/30">
              <div className="space-y-2">
                ...
                <p className="text-on-surface-variant text-sm leading-relaxed">
                  To democratize elite medical access through strategic partnerships and compassionate patient advocacy.
                </p>
              </div>
              <div className="space-y-2">
                <h3 className="font-bold text-secondary text-lg">Vision</h3>
                <p className="text-on-surface-variant text-sm leading-relaxed">
                  To be the world&apos;s most trusted medical bridge, setting the global standard for consultancy ethics.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-surface border-y border-outline-variant/20 relative z-10">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-[120px]">
          <div className="text-center mb-16 reveal">
            <h2 className="font-headline-lg text-headline-lg mb-4 text-on-surface">Our Core Values</h2>
            <p className="text-on-surface-variant max-w-2xl mx-auto text-sm">
              The principles that guide every consultation, patient journey, and institutional partnership.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((val, idx) => (
              ...
              >
                ...
                <h3 className="font-bold text-on-surface mb-3 text-lg">{val.title}</h3>
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-[120px]">
          <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-16">
            <div className="max-w-2xl reveal">
              <h2 className="font-headline-lg text-headline-lg mb-4 text-on-surface">Our Growth Journey</h2>
              <p className="text-on-surface-variant text-sm">
                From a boutique consultancy to a global medical facilitator, our growth is a testament to the trust of thousands of patients.
              </p>
            </div>
            <div className="hidden md:block reveal delay-200">
              <span className="text-primary font-bold text-headline-xl opacity-10 uppercase tracking-widest">Est. 2012</span>
            </div>
          </div>
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 relative z-10">
              {timeline.map((item, idx) => (
                <div key={item.year} className="space-y-6 reveal" style={{ transitionDelay: `${idx * 100}ms` }}>
                  <div className={`w-12 h-12 ${item.color} ${idx % 2 === 1 ? 'lg:mt-12' : ''} text-on-primary rounded-full flex items-center justify-center font-bold relative z-10 shadow-md`}>
                    {item.year}
                  </div>
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-[120px]">
          <div className="glass-card rounded-[2.5rem] overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[500px]">
            <div className="lg:col-span-4 p-10 md:p-12 flex flex-col justify-center space-y-8 bg-on-tertiary-fixed text-white relative">
              <h2 className="font-headline-lg text-headline-lg leading-tight">Our Global Footprint</h2>
              <p className="opacity-80 text-sm leading-relaxed">
                We have hand-selected medical partners in over 15 countries, ensuring our patients receive the best care, regardless of geography.
              </p>
            ...
            <div className="lg:col-span-8 bg-slate-100 relative flex items-center justify-center p-8 overflow-hidden min-h-[300px]">
              <div className="absolute inset-0 opacity-15 pointer-events-none flex items-center justify-center">
                <span className="material-symbols-outlined text-[300px] text-slate-900 select-none">public</span>
              </div>
      ...
      <section className="py-20 bg-surface border-t border-outline-variant/20 relative z-10" id="ethics">
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-[120px]">
          <div className="text-center mb-16 reveal">
            <h2 className="font-headline-lg text-headline-lg mb-4 text-on-surface">Leadership &amp; Advisory</h2>
            <p className="text-on-surface-variant max-w-2xl mx-auto text-sm">
              Led by medical visionaries and administrative experts committed to ethical global healthcare.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {leaders.map((leader, index) => (
              ...
              >
                <div className="relative overflow-hidden rounded-[2rem] mb-6 aspect-[3/4] shadow-md border border-outline-variant/10">
                  <Image
                    src={leader.image}
                    alt={leader.name}
                    fill
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-on-tertiary-fixed/90 via-on-tertiary-fixed/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-6 text-white">
                    <p className="text-xs leading-relaxed opacity-90">{leader.bio}</p>
                ...
                <h4 className="font-headline-md text-headline-md mb-1 text-on-surface text-lg md:text-xl">{leader.name}</h4>
                <p className="text-primary font-bold text-xs uppercase tracking-wider">{leader.role}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-[120px]">
          <div className="bg-primary-container p-10 md:p-16 rounded-[2.5rem] text-on-primary-container text-center relative overflow-hidden shadow-xl border border-primary/20">
            ...
            <p className="text-body-lg text-body-lg mb-10 max-w-2xl mx-auto opacity-95 relative z-10 text-sm md:text-base leading-relaxed">
              Our consultants are ready to provide the clarity and expertise you need for your healthcare decisions. Reach out for a confidential review today.
            </p>
            <button 
              onClick={triggerConsultation}
