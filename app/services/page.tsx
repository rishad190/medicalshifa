...
export default function ServicesPage() {
  ...
  const services = [
    {
      ...
      description:
        "Direct access to world-renowned specialists across multiple disciplines for diagnostic clarity and treatment planning.",
      features: [
        "Personalized Case Briefing",
        "Expert Clinical Reviews",
        "Video & Audio Consultation Slots",
      ],
    },
    {
      ...
      description:
        "We coordinate admissions to JCI-accredited global hospitals, ensuring you receive care at the most appropriate facility.",
      features: [
        "Priority Scheduling",
        "Hospital Admissions Liaison",
        "Accredited Network Access",
      ],
    },
    {
      id: "second-opinion",
      ...
      description:
        "Validate complex diagnoses with independent reviews from senior medical boards and international experts.",
      features: [
    ...
    },
    {
      ...
      description:
        "End-to-end logistics including visa support, medical air travel coordination, and local accommodation for families.",
      features: [
        "Medical Visa Fast-tracking",
    ...
    },
    {
      ...
      description:
        "Secure, HD video consultations from the comfort of your home, integrated with your existing medical records.",
      features: [
        "HIPAA Compliant Software",
        "Digital Prescription Dispatch",
        "Remote Patient Vital Tracking",
      ],
    },
    {
      ...
      description:
        "Navigating international coverage and claims. We help maximize your benefits and handle pre-authorizations.",
      features: [
        "Pre-Authorization Handling",
        "Global Claims Assistance",
        "Coverage Policy Audits",
      ],
    },
  ];
  ...
  const steps = [
    {
      ...
      content:
        "Submit your medical history and current concerns via our secure portal. Our medical directors perform a preliminary triage to identify the most relevant specialists in our global network.",
    },
    {
      title: "Specialist Matchmaking",
      content:
        "We present 2-3 top-tier medical facilities or specialists based on your specific condition, insurance, and personal preferences, providing transparent cost estimates for each.",
    },
    {
      title: "Treatment Coordination",
      content:
        "Once a choice is made, we handle all appointments, file transfers, and travel arrangements. Your dedicated case manager remains available 24/7 during your journey.",
    },
    {
      title: "Post-Care Follow-up",
      content:
        "Care doesn't end when you leave the hospital. We ensure your local doctors receive all reports and coordinate necessary follow-up telemedicine sessions.",
    },
  ];
    ...
    dbServices.length > 0
      ? [
          ...dbServices.map((s) => ({
            ...
            features: s.tags
              ? s.tags.split(",")
              : ["Personalized Care", "Global Coordination"],
          })),
          ...services,
        ]
      : services;
  ...
  return (
    <div className="flex flex-col w-full bg-background min-h-screen">
      ...
      <div className="absolute top-0 left-0 w-full h-[500px] bg-linear-to-b from-primary/5 to-transparent pointer-events-none z-0" />
      ...
      <section className="mx-auto max-w-360 px-6 md:px-12 lg:px-grid-margin-desktop py-16 relative z-10">
        <div className="max-w-3xl">
          ...
          <p className="font-body-lg text-body-lg text-on-surface-variant leading-relaxed">
            We bridge the gap between world-class medical facilities and
            patients seeking excellence. Our services are designed with an
            empathetic touch and medical precision.
          </p>
        </div>
      </section>
        ...
        {filteredServices.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredServices.map((service, idx) => (
              ...
              >
                <div>
                  <div
                    className={`w-12 h-12 rounded-xl ${service.iconBg} ${service.iconColor} flex items-center justify-center mb-6 shadow-sm`}
                  >
          ...
          <div className="text-center py-20 bg-white/20 rounded-2xl border border-dashed border-outline-variant/30">
            ...
            <p className="text-on-surface-variant max-w-xs mx-auto text-sm">
              ...
              &rdquo;. Try adjusting your filters or search query.
            </p>
          </div>
        )}
      </section>
      ...
      <section className="bg-surface-container-low py-20 overflow-hidden relative z-10">
        <div className="mx-auto max-w-360 px-6 md:px-12 lg:px-grid-margin-desktop grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="reveal delay-150">
            <span className="text-secondary font-label-sm tracking-widest block mb-4 uppercase">
              Institutional Care
            </span>
            <h2 className="font-headline-lg text-headline-lg mb-8 leading-tight">
              Corporate Healthcare &amp; Patient Coordination
            </h2>
            <div className="space-y-8">
              <div className="flex gap-6">
                ...
                <div>
                  <h4 className="font-bold text-on-surface mb-2 text-base md:text-lg">
                    Corporate Wellness
                  </h4>
                  <p className="text-on-surface-variant text-sm leading-relaxed">
                    Custom healthcare strategies for multinational
                    organizations, ensuring employee health across borders.
                  </p>
                </div>
              </div>
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-on-surface-variant text-sm leading-relaxed">
                    Every patient is assigned a personal advocate to navigate
                    linguistic, cultural, and administrative barriers.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="mx-auto max-w-360 px-6 md:px-12 lg:px-grid-margin-desktop py-20 relative z-10">
        <div className="text-center mb-16 reveal">
          ...
          <p className="text-on-surface-variant max-w-2xl mx-auto text-sm">
            Our streamlined process ensures you never feel lost in the medical
            maze.
          </p>
        </div>
              ...
              >
                ...
                <div
                  className={`px-8 text-on-surface-variant text-sm leading-relaxed overflow-hidden transition-all duration-300 ${
                    isOpen
                      ? "pb-6 pt-2 max-h-40 opacity-100"
      ...
      {/* Booking CTA */}
      <section className="mx-auto max-w-360 px-6 md:px-12 lg:px-grid-margin-desktop mb-20 relative z-10">
        <div className="bg-inverse-surface rounded-[2rem] p-10 md:p-20 text-center relative overflow-hidden shadow-xl">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-white/70 font-body-lg text-body-lg mb-10 text-sm md:text-base">
              Join thousands of patients who have found clarity and healing
              through Shifa Global Care&apos;s curated medical network.
            </p>
