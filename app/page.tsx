...
export default function Home() {
    ...
    async function loadPartners() {
      try {
        ...
        if (res.ok) {
          ...
          const publicPartners = data.filter(
  ...
  const testimonials = [
    {
      ...
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuCh_xmAs7bBqSd8uY-FUJxWE7d2d1pII__LBRZjfhNdIIxbvvKyD6C5TOuGudI5YmH2KLThZOMmm10h6VKISOP24jNQvX46TCPGilIwtHjkIGjORYXf7UVQYZYOu_hD2g-Dtg6OegFmCIeyGf4znlYvQRv2nSoyLOogN5EBLJXdpFk-Qqj640LlPCtFeVnODmqD-8A480MkUWLJIXAYHlugC3SAfxc85wmtclztmssrslwgBpDv254pSDxB08rLjJ6mr7iOtalvcdE",
    },
    {
  ...
  return (
    <div className="flex flex-col w-full">
      {/* Hero Section */}
      <section className="relative min-h-[85vh] flex items-center overflow-hidden bg-linear-to-br from-surface via-surface-container-low to-surface-container/30">
        <div className="mx-auto max-w-360 px-6 md:px-12 lg:px-grid-margin-desktop grid md:grid-cols-2 gap-16 items-center relative z-10 py-16">
          <div className="reveal">
            ...
            <p className="font-body-lg text-body-lg text-on-surface-variant mb-10 max-w-lg">
              Connecting you with elite medical specialists and world-renowned
              hospitals. Our expert consultants handle the complexity so you can
              focus on healing.
            </p>
          ...
          <div className="relative reveal delay-200">
            <div className="aspect-4/5 rounded-4xl overflow-hidden shadow-2xl relative w-full max-w-md mx-auto md:ml-auto">
              <Image
            ...
            <div className="absolute -bottom-6 -left-6 md:-left-10 glass-card p-6 md:p-8 rounded-2xl max-w-xs animate-bounce-subtle hidden sm:block">
              ...
              <p className="text-xs md:text-sm italic text-on-surface-variant">
                &ldquo;Shifa handled everything from my second opinion to travel
                logistics. Exceptional care.&rdquo;
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-primary text-on-primary py-12 relative overflow-hidden">
        <div className="mx-auto max-w-360 px-6 md:px-12 lg:px-grid-margin-desktop relative z-10 flex flex-wrap justify-around gap-12">
          <div className="text-center reveal">
            <p className="font-headline-lg text-headline-lg font-bold">10k+</p>
            <p className="font-label-sm text-label-sm opacity-80 uppercase tracking-widest mt-1">
              Patients Assisted
            </p>
          </div>
      ...
      <section className="py-20 mx-auto max-w-360 px-6 md:px-12 lg:px-grid-margin-desktop">
        <div className="text-center mb-16 reveal">
          <h2 className="font-headline-lg text-headline-lg text-on-surface mb-4">
            Why Global Patients Trust Shifa
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="md:col-span-2 glass-card p-8 md:p-10 rounded-2xl glass-card-hover reveal">
            ...
            <p className="text-on-surface-variant leading-relaxed text-sm">
              Our panel consists of retired chief medical officers and
              consultants with decades of experience in navigating international
          ...
          <div className="glass-card p-8 md:p-10 rounded-2xl glass-card-hover reveal delay-100">
            ...
            <p className="text-on-surface-variant leading-relaxed text-sm">
              Direct bridges to the world&apos;s most prestigious medical
              institutions in the UK, USA, and Germany.
            </p>
          </div>
          <div className="glass-card p-8 md:p-10 rounded-2xl glass-card-hover reveal delay-200">
            ...
            <p className="text-on-surface-variant leading-relaxed text-sm">
              Absolute patient confidentiality and ethical medical practices are
              our core pillars.
            </p>
          </div>
          <div className="md:col-span-4 glass-card p-8 md:p-10 rounded-2xl flex flex-col md:flex-row items-center gap-10 glass-card-hover reveal delay-300">
            <div className="flex-1">
              ...
              <p className="text-on-surface-variant leading-relaxed text-sm">
                From the first call to post-treatment recovery, our dedicated
                care managers are by your side 24/7 across timezones.
              </p>
            </div>
      ...
      <section className="py-20 bg-surface-container-low">
        <div className="mx-auto max-w-360 px-6 md:px-12 lg:px-grid-margin-desktop">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6 reveal">
            <div>
              <h2 className="font-headline-lg text-headline-lg text-on-surface mb-4">
                Curated Medical Services
              </h2>
              <p className="text-on-surface-variant max-w-xl">
                We provide end-to-end medical logistics and consultancy to
                ensure you receive the best treatment outcomes globally.
              </p>
            </div>
            <Link
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 reveal">
              ...
              <div className="p-8">
                ...
                <p className="text-on-surface-variant mb-6 text-sm">
                  Direct access to elite physicians for diagnosis confirmation
            ...
            <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 reveal delay-100">
              ...
              <div className="p-8">
                ...
                <p className="text-on-surface-variant mb-6 text-sm">
                  Seamless admission to top-tier international hospitals with
            ...
            <div className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 reveal delay-200">
              ...
              <div className="p-8">
                ...
                <p className="text-on-surface-variant mb-6 text-sm">
                  Receive a comprehensive medical review from a
                  multi-disciplinary team of international experts.
                </p>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center gap-3 text-sm text-on-surface-variant">
                    <span
      ...
      <section className="py-20 mx-auto max-w-360 px-6 md:px-12 lg:px-grid-margin-desktop">
        <div className="text-center mb-16 reveal">
          ...
          <p className="text-on-surface-variant text-sm">
            Simple, transparent, and expert-led steps.
          </p>
        </div>
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
            <div className="flex flex-col items-center text-center reveal bg-background p-4 rounded-xl">
              <div className="w-16 h-16 rounded-full bg-primary text-on-primary flex items-center justify-center font-bold text-xl mb-6 shadow-lg">
                1
              </div>
              ...
              <p className="text-on-surface-variant text-sm max-w-xs">
                Share your medical history and goals with our consultants
            ...
            <div className="flex flex-col items-center text-center reveal delay-100 bg-background p-4 rounded-xl">
              ...
              <p className="text-on-surface-variant text-sm max-w-xs">
                We match your case with the top 3 global specialists and present
                a detailed digital care plan.
              </p>
            </div>
            <div className="flex flex-col items-center text-center reveal delay-200 bg-background p-4 rounded-xl">
              ...
              <p className="text-on-surface-variant text-sm max-w-xs">
                We manage all appointments, travel, and follow-ups while you
                focus entirely on getting better.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-360 px-6 md:px-12 lg:px-grid-margin-desktop">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6 reveal">
            <div>
              ...
              <p className="text-on-surface-variant text-sm">
                Empathetic support makes all the difference.
              </p>
            </div>
      ...
      <section className="py-20 mx-auto max-w-360 px-6 md:px-12 lg:px-grid-margin-desktop">
        <div className="text-center mb-16 reveal">
          ...
          <p className="text-on-surface-variant text-sm">
            Everything you need to know about our global healthcare consultancy.
          </p>
        </div>
        <div className="max-w-3xl mx-auto space-y-4">
          {faqs.map((faq, index) => {
            ...
            return (
              <div
                key={index}
                className="glass-card rounded-2xl overflow-hidden reveal transition-all duration-300"
              >
                <button
          ...
          <div className="bg-primary rounded-[2.5rem] p-10 md:p-20 relative overflow-hidden text-center reveal shadow-2xl">
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <p className="font-body-lg text-body-lg text-on-primary/80 mb-10 text-sm md:text-base">
                Start your journey with a complimentary case review by our
                expert medical consultants today.
              </p>
