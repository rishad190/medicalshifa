...
export default function Footer() {
  ...
  return (
    <footer className="bg-surface-container-lowest border-t border-outline-variant/30 w-full relative z-10">
      <div className="mx-auto max-w-360 px-6 md:px-12 lg:px-grid-margin-desktop py-16 grid grid-cols-1 md:grid-cols-4 gap-8">
        {/* Branding & Socials */}
        <div className="md:col-span-1">
          <Link
            href="/"
            className="font-headline-md text-headline-md font-bold text-primary mb-6 block"
          >
            Shifa Global
          </Link>
          <p className="text-on-surface-variant mb-6 text-sm leading-relaxed max-w-xs">
            Excellence in international healthcare consultancy, bridging the gap
            between patients and elite medical care worldwide.
          </p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-xs text-on-surface-variant mb-3 leading-relaxed">
            Stay updated with the latest medical breakthroughs, specialist
            advice, and global care logistics.
          </p>
      ...
      {/* Footer Bottom Strip */}
      <div className="mx-auto max-w-360 px-6 md:px-12 lg:px-grid-margin-desktop py-8 border-t border-outline-variant/20 flex flex-col md:flex-row justify-between items-center gap-4 text-xs">
        <p className="text-on-surface-variant opacity-80">
          © {new Date().getFullYear()} Shifa Global Care. Excellence in
